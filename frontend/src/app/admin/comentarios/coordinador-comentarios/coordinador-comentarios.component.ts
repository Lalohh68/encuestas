...
export class CoordinadorComentariosComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.dtOptions = {
      ...
      buttons: [
        {
          extend: 'excel',
          title: 'Comentarios_CoordinadorDeCarreras',
          text: '',
  ...
  getComentarios() {
    this.adminService.comentariosCoordinadorDeCarreras().subscribe((data) => {
