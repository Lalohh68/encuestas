  ...
  ngOnInit(): void {
    this.adminService.dataCoordinadorDeCarreras().subscribe(
      data =>{this.coordinadorDeCarreras=data,this.dtTrigger,
        this.total= ((this.coordinadorDeCarreras[0].total)),
        this.satisfechoHorario= ((this.coordinadorDeCarreras[0].horario_satisfechos / this.coordinadorDeCarreras[0].total)*100),
        this.noSatisfechoHorario= (this.coordinadorDeCarreras[0].horario_no_satisfechos / this.coordinadorDeCarreras[0].total)*100;
        this.satisfechoDisponibilidad= (this.coordinadorDeCarreras[0].disponibilidad_satisfechos / this.coordinadorDeCarreras[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.coordinadorDeCarreras[0].disponibilidad_no_satisfechos / this.coordinadorDeCarreras[0].total)*100; 
        this.satisfechoAtencion= (this.coordinadorDeCarreras[0].atencion_satisfechos / this.coordinadorDeCarreras[0].total)*100,
        this.noSatisfechoAtencion= (this.coordinadorDeCarreras[0].atencion_no_satisfechos / this.coordinadorDeCarreras[0].total)*100;  
        this.satisfechoAmabilidad= (this.coordinadorDeCarreras[0].amabilidad_satisfechos / this.coordinadorDeCarreras[0].total)*100,
        this.noSatisfechoAmabilidad= (this.coordinadorDeCarreras[0].amabilidad_no_satisfechos / this.coordinadorDeCarreras[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
