  ...
  ngOnInit(): void {
    this.adminService.dataIdiomas().subscribe(
      data =>{this.idiomas=data,this.dtTrigger,
        this.total= ((this.idiomas[0].total)),
        this.satisfechoHorario= ((this.idiomas[0].horario_satisfechos / this.idiomas[0].total)*100),
        this.noSatisfechoHorario= (this.idiomas[0].horario_no_satisfechos / this.idiomas[0].total)*100;
        this.satisfechoDisponibilidad= (this.idiomas[0].disponibilidad_satisfechos / this.idiomas[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.idiomas[0].disponibilidad_no_satisfechos / this.idiomas[0].total)*100; 
        this.satisfechoAtencion= (this.idiomas[0].atencion_satisfechos / this.idiomas[0].total)*100,
        this.noSatisfechoAtencion= (this.idiomas[0].atencion_no_satisfechos / this.idiomas[0].total)*100;  
        this.satisfechoAmabilidad= (this.idiomas[0].amabilidad_satisfechos / this.idiomas[0].total)*100,
        this.noSatisfechoAmabilidad= (this.idiomas[0].amabilidad_no_satisfechos / this.idiomas[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
