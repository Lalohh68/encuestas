  ...
  ngOnInit(): void {
    this.adminService.dataCafeteria2().subscribe(
      data =>{this.cafeteria2=data,this.dtTrigger,
        this.total= ((this.cafeteria2[0].total)),
        this.satisfechoHorario= ((this.cafeteria2[0].horario_satisfechos / this.cafeteria2[0].total)*100),
        this.noSatisfechoHorario= (this.cafeteria2[0].horario_no_satisfechos / this.cafeteria2[0].total)*100;
        this.satisfechoDisponibilidad= (this.cafeteria2[0].disponibilidad_satisfechos / this.cafeteria2[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.cafeteria2[0].disponibilidad_no_satisfechos / this.cafeteria2[0].total)*100; 
        this.satisfechoAtencion= (this.cafeteria2[0].atencion_satisfechos / this.cafeteria2[0].total)*100,
        this.noSatisfechoAtencion= (this.cafeteria2[0].atencion_no_satisfechos / this.cafeteria2[0].total)*100;  
        this.satisfechoAmabilidad= (this.cafeteria2[0].amabilidad_satisfechos / this.cafeteria2[0].total)*100,
        this.noSatisfechoAmabilidad= (this.cafeteria2[0].amabilidad_no_satisfechos / this.cafeteria2[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
