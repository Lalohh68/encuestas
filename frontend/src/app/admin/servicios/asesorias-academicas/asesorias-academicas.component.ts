  ...
  ngOnInit(): void {
    ...
    this.adminService.dataAsesoriasAcademicas().subscribe(
      data =>{this.asesoriasAcademicas=data,this.dtTrigger,
        ...
        this.satisfechoHorario= ((this.asesoriasAcademicas[0].horario_satisfechos / this.asesoriasAcademicas[0].total)*100),
        this.noSatisfechoHorario= (this.asesoriasAcademicas[0].horario_no_satisfechos / this.asesoriasAcademicas[0].total)*100;
        this.satisfechoDisponibilidad= (this.asesoriasAcademicas[0].disponibilidad_satisfechos / this.asesoriasAcademicas[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.asesoriasAcademicas[0].disponibilidad_no_satisfechos / this.asesoriasAcademicas[0].total)*100; 
        this.satisfechoAtencion= (this.asesoriasAcademicas[0].atencion_satisfechos / this.asesoriasAcademicas[0].total)*100,
        this.noSatisfechoAtencion= (this.asesoriasAcademicas[0].atencion_no_satisfechos / this.asesoriasAcademicas[0].total)*100;  
        this.satisfechoAmabilidad= (this.asesoriasAcademicas[0].amabilidad_satisfechos / this.asesoriasAcademicas[0].total)*100,
        this.noSatisfechoAmabilidad= (this.asesoriasAcademicas[0].amabilidad_no_satisfechos / this.asesoriasAcademicas[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
