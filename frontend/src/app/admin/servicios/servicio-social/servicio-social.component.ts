  ...
  ngOnInit(): void {
    this.adminService.dataServicioSocial().subscribe(
      data =>{this.servicioSocial=data,this.dtTrigger,
        this.total= ((this.servicioSocial[0].total)),
        this.satisfechoHorario= ((this.servicioSocial[0].horario_satisfechos / this.servicioSocial[0].total)*100),
        this.noSatisfechoHorario= (this.servicioSocial[0].horario_no_satisfechos / this.servicioSocial[0].total)*100;
        this.satisfechoDisponibilidad= (this.servicioSocial[0].disponibilidad_satisfechos / this.servicioSocial[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.servicioSocial[0].disponibilidad_no_satisfechos / this.servicioSocial[0].total)*100; 
        this.satisfechoAtencion= (this.servicioSocial[0].atencion_satisfechos / this.servicioSocial[0].total)*100,
        this.noSatisfechoAtencion= (this.servicioSocial[0].atencion_no_satisfechos / this.servicioSocial[0].total)*100;  
        this.satisfechoAmabilidad= (this.servicioSocial[0].amabilidad_satisfechos / this.servicioSocial[0].total)*100,
        this.noSatisfechoAmabilidad= (this.servicioSocial[0].amabilidad_no_satisfechos / this.servicioSocial[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
