  ...
  ngOnInit(): void {
    this.adminService.dataBiblioteca().subscribe(
      data =>{this.biblioteca=data,this.dtTrigger,
        this.total= ((this.biblioteca[0].total)),
        this.satisfechoHorario= ((this.biblioteca[0].horario_satisfechos / this.biblioteca[0].total)*100),
        this.noSatisfechoHorario= (this.biblioteca[0].horario_no_satisfechos / this.biblioteca[0].total)*100;
        this.satisfechoDisponibilidad= (this.biblioteca[0].disponibilidad_satisfechos / this.biblioteca[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.biblioteca[0].disponibilidad_no_satisfechos / this.biblioteca[0].total)*100; 
        this.satisfechoAtencion= (this.biblioteca[0].atencion_satisfechos / this.biblioteca[0].total)*100,
        this.noSatisfechoAtencion= (this.biblioteca[0].atencion_no_satisfechos / this.biblioteca[0].total)*100;  
        this.satisfechoAmabilidad= (this.biblioteca[0].amabilidad_satisfechos / this.biblioteca[0].total)*100,
        this.noSatisfechoAmabilidad= (this.biblioteca[0].amabilidad_no_satisfechos / this.biblioteca[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
