  ...
  ngOnInit(): void {
    this.adminService.dataMedico().subscribe(
      data =>{this.medico=data,this.dtTrigger,
        this.total= ((this.medico[0].total)),
        this.satisfechoHorario= ((this.medico[0].horario_satisfechos / this.medico[0].total)*100),
        this.noSatisfechoHorario= (this.medico[0].horario_no_satisfechos / this.medico[0].total)*100;
        this.satisfechoDisponibilidad= (this.medico[0].disponibilidad_satisfechos / this.medico[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.medico[0].disponibilidad_no_satisfechos / this.medico[0].total)*100; 
        this.satisfechoAtencion= (this.medico[0].atencion_satisfechos / this.medico[0].total)*100,
        this.noSatisfechoAtencion= (this.medico[0].atencion_no_satisfechos / this.medico[0].total)*100;  
        this.satisfechoAmabilidad= (this.medico[0].amabilidad_satisfechos / this.medico[0].total)*100,
        this.noSatisfechoAmabilidad= (this.medico[0].amabilidad_no_satisfechos / this.medico[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
