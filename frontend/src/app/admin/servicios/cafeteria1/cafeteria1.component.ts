  ...
  ngOnInit(): void {
    this.adminService.dataCafeteria1().subscribe(
      data =>{this.cafeteria1=data,this.dtTrigger,
        this.total= ((this.cafeteria1[0].total)),
        this.satisfechoHorario= ((this.cafeteria1[0].horario_satisfechos / this.cafeteria1[0].total)*100),
        this.noSatisfechoHorario= (this.cafeteria1[0].horario_no_satisfechos / this.cafeteria1[0].total)*100;
        this.satisfechoDisponibilidad= (this.cafeteria1[0].disponibilidad_satisfechos / this.cafeteria1[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.cafeteria1[0].disponibilidad_no_satisfechos / this.cafeteria1[0].total)*100; 
        this.satisfechoAtencion= (this.cafeteria1[0].atencion_satisfechos / this.cafeteria1[0].total)*100,
        this.noSatisfechoAtencion= (this.cafeteria1[0].atencion_no_satisfechos / this.cafeteria1[0].total)*100;  
        this.satisfechoAmabilidad= (this.cafeteria1[0].amabilidad_satisfechos / this.cafeteria1[0].total)*100,
        this.noSatisfechoAmabilidad= (this.cafeteria1[0].amabilidad_no_satisfechos / this.cafeteria1[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
