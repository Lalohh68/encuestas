  ...
  ngOnInit(): void {
    this.adminService.dataTutorias().subscribe(
      data =>{this.tutorias=data,this.dtTrigger,
        this.total= ((this.tutorias[0].total)),
        this.satisfechoHorario= ((this.tutorias[0].horario_satisfechos / this.tutorias[0].total)*100),
        this.noSatisfechoHorario= (this.tutorias[0].horario_no_satisfechos / this.tutorias[0].total)*100;
        this.satisfechoDisponibilidad= (this.tutorias[0].disponibilidad_satisfechos / this.tutorias[0].total)*100,
        this.noSatisfechoDisponibilidad= (this.tutorias[0].disponibilidad_no_satisfechos / this.tutorias[0].total)*100; 
        this.satisfechoAtencion= (this.tutorias[0].atencion_satisfechos / this.tutorias[0].total)*100,
        this.noSatisfechoAtencion= (this.tutorias[0].atencion_no_satisfechos / this.tutorias[0].total)*100;  
        this.satisfechoAmabilidad= (this.tutorias[0].amabilidad_satisfechos / this.tutorias[0].total)*100,
        this.noSatisfechoAmabilidad= (this.tutorias[0].amabilidad_no_satisfechos / this.tutorias[0].total)*100; 
        this.barChartData={
      labels: [ 'Horario', 'Disponibilidad', 'Atención', 'Amabilidad'],
      datasets: [
