...
import { MecatronicaService } from '../../services/mecatronica.service';
...
export class MecatronicaComponent implements OnInit {
  ...
  constructor(private mecatronicaService: MecatronicaService, ){}
  ngOnInit(): void {
    this.mecatronicaService.dataClubes().subscribe(
    ...
    this.mecatronicaService.dataControlEscolar().subscribe(
    ...
    this.mecatronicaService.dataTutorias().subscribe(
    ...
    this.mecatronicaService.dataBiblioteca().subscribe(
    ...
    this.mecatronicaService.dataCentroDeComputo().subscribe(
    ...
    this.mecatronicaService.dataServicioSocial().subscribe(
    ...
    this.mecatronicaService.dataResidencias().subscribe(
    ...
    this.mecatronicaService.dataIdiomas().subscribe(
    ...
    this.mecatronicaService.dataCafeteria1().subscribe(
    ...
    this.mecatronicaService.dataCafeteria2().subscribe(
    ...
    this.mecatronicaService.dataCajas().subscribe(
    ...
    this.mecatronicaService.dataCoordinadorDeCarreras().subscribe(
    ...
    this.mecatronicaService.dataBecas().subscribe(
    ...
    this.mecatronicaService.dataCentroDeCopiado().subscribe(
    ...
    this.mecatronicaService.dataPsicologico().subscribe(
    ...
    this.mecatronicaService.dataMedico().subscribe(
    ...
    this.mecatronicaService.dataAsesoriasAcademicas().subscribe(
