...
import { BioquimicaService} from '../../services/bioquimica.service';
...
export class BioquimicaComponent implements OnInit {
  ...
  constructor(private bioquimicaService: BioquimicaService, ){}
  ngOnInit(): void {
    this.bioquimicaService.dataClubes().subscribe(
    ...
    this.bioquimicaService.dataControlEscolar().subscribe(
    ...
    this.bioquimicaService.dataTutorias().subscribe(
    ...
    this.bioquimicaService.dataBiblioteca().subscribe(
    ...
    this.bioquimicaService.dataCentroDeComputo().subscribe(
    ...
    this.bioquimicaService.dataServicioSocial().subscribe(
    ...
    this.bioquimicaService.dataResidencias().subscribe(
    ...
    this.bioquimicaService.dataIdiomas().subscribe(
    ...
    this.bioquimicaService.dataCafeteria1().subscribe(
    ...
    this.bioquimicaService.dataCafeteria2().subscribe(
    ...
    this.bioquimicaService.dataCajas().subscribe(
    ...
    this.bioquimicaService.dataCoordinadorDeCarreras().subscribe(
    ...
    this.bioquimicaService.dataBecas().subscribe(
    ...
    this.bioquimicaService.dataCentroDeCopiado().subscribe(
    ...
    this.bioquimicaService.dataPsicologico().subscribe(
    ...
    this.bioquimicaService.dataMedico().subscribe(
    ...
    this.bioquimicaService.dataAsesoriasAcademicas().subscribe(
