...
export class GestionComponent implements OnInit {
  ...
  constructor(private sistemasService: GestionService, ){}
  ngOnInit(): void {
    this.sistemasService.dataClubes().subscribe(
    ...
    this.sistemasService.dataControlEscolar().subscribe(
    ...
    this.sistemasService.dataTutorias().subscribe(
    ...
    this.sistemasService.dataBiblioteca().subscribe(
    ...
    this.sistemasService.dataCentroDeComputo().subscribe(
    ...
    this.sistemasService.dataServicioSocial().subscribe(
    ...
    this.sistemasService.dataResidencias().subscribe(
    ...
    this.sistemasService.dataIdiomas().subscribe(
    ...
    this.sistemasService.dataCafeteria1().subscribe(
    ...
    this.sistemasService.dataCafeteria2().subscribe(
    ...
    this.sistemasService.dataCajas().subscribe(
    ...
    this.sistemasService.dataCoordinadorDeCarreras().subscribe(
    ...
    this.sistemasService.dataBecas().subscribe(
    ...
    this.sistemasService.dataCentroDeCopiado().subscribe(
    ...
    this.sistemasService.dataPsicologico().subscribe(
    ...
    this.sistemasService.dataMedico().subscribe(
    ...
    this.sistemasService.dataAsesoriasAcademicas().subscribe(
