...
import { NanoService } from '../../services/nano.service';
...
export class NanoComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.nanoService.dataClubes().subscribe(
    ...
    this.nanoService.dataControlEscolar().subscribe(
    ...
    this.nanoService.dataTutorias().subscribe(
    ...
    this.nanoService.dataBiblioteca().subscribe(
    ...
    this.nanoService.dataCentroDeComputo().subscribe(
    ...
    this.nanoService.dataServicioSocial().subscribe(
    ...
    this.nanoService.dataResidencias().subscribe(
    ...
    this.nanoService.dataIdiomas().subscribe(
    ...
    this.nanoService.dataCafeteria1().subscribe(
    ...
    this.nanoService.dataCafeteria2().subscribe(
    ...
    this.nanoService.dataCajas().subscribe(
    ...
    this.nanoService.dataCoordinadorDeCarreras().subscribe(
    ...
    this.nanoService.dataBecas().subscribe(
    ...
    this.nanoService.dataCentroDeCopiado().subscribe(
    ...
    this.nanoService.dataPsicologico().subscribe(
    ...
    this.nanoService.dataMedico().subscribe(
    ...
    this.nanoService.dataAsesoriasAcademicas().subscribe(
