...
export class IndustrialComponent implements OnInit {
  ...
  constructor(private industrialService: IndustrialService, ){}
  ngOnInit(): void {
    this.industrialService.dataClubes().subscribe(
    ...
    this.industrialService.dataControlEscolar().subscribe(
    ...
    this.industrialService.dataTutorias().subscribe(
    ...
    this.industrialService.dataBiblioteca().subscribe(
    ...
    this.industrialService.dataCentroDeComputo().subscribe(
    ...
    this.industrialService.dataServicioSocial().subscribe(
    ...
    this.industrialService.dataResidencias().subscribe(
    ...
    this.industrialService.dataIdiomas().subscribe(
    ...
    this.industrialService.dataCafeteria1().subscribe(
    ...
    this.industrialService.dataCafeteria2().subscribe(
    ...
    this.industrialService.dataCajas().subscribe(
    ...
    this.industrialService.dataCoordinadorDeCarreras().subscribe(
    ...
    this.industrialService.dataBecas().subscribe(
    ...
    this.industrialService.dataCentroDeCopiado().subscribe(
    ...
    this.industrialService.dataPsicologico().subscribe(
    ...
    this.industrialService.dataMedico().subscribe(
    ...
    this.industrialService.dataAsesoriasAcademicas().subscribe(
